        ...
        <div class="card">
            <div class="card-body">
                <div class="btn-group" role="group" aria-label="manage">
                    @php $permissionsNeeded = ['account_group.create']; $hasAccess = array_intersect($permissionsNeeded, $setting->list_of_permission); @endphp
                    @if ($hasAccess)
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            ...
                            if (permissions.includes('account_group.edit')) {
                                actions += `<a href="{{ url('account_group') }}/${row.id}/edit" class="btn btn-secondary btn-sm">Edit</a>`;
                            }
                            if (permissions.includes('account_group.destroy')) {
