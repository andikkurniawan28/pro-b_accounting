        ...
        <div class="card">
            <div class="card-body">
                <div class="btn-group" role="group" aria-label="manage">
                    @php $permissionsNeeded = ['currency.create']; $hasAccess = array_intersect($permissionsNeeded, $setting->list_of_permission); @endphp
                    @if ($hasAccess)
                ...
                <div class="table-responsive">
                    <br>
                    <table class="table table-bordered table-hovered" id="currency_table" width="100%">
                        <thead>
                            <tr>
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            ...
                            if (permissions.includes('currency.edit')) {
                                actions += `<a href="{{ url('currency') }}/${row.id}/edit" class="btn btn-secondary btn-sm">Edit</a>`;
                            }
                            if (permissions.includes('currency.destroy')) {
            ...
            $(document).on('click', '.delete-btn', function(event) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        const form = $('<form>', {
                            method: 'POST',
                            action: `{{ url('currency') }}/${currencyId}`
                        });
