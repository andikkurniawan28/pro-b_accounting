...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Menu::insert([
            ...
            ["name" => Str::title(str_replace('_', ' ', 'payment_term_list')), "route" => "payment_term.index"],
            ["name" => Str::title(str_replace('_', ' ', 'create_payment_term')), "route" => "payment_term.create"],
            ["name" => Str::title(str_replace('_', ' ', 'save_payment_term')), "route" => "payment_term.store"],
            ["name" => Str::title(str_replace('_', ' ', 'edit_payment_term')), "route" => "payment_term.edit"],
            ["name" => Str::title(str_replace('_', ' ', 'update_payment_term')), "route" => "payment_term.update"],
            ["name" => Str::title(str_replace('_', ' ', 'delete_payment_term')), "route" => "payment_term.destroy"],
